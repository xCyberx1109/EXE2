...
export const mapInventoryTransaction = (tx) => ({
  ...
  beforeQuantity: tx.beforeQuantity !== null && tx.beforeQuantity !== undefined ? Number(tx.beforeQuantity) : null,
  afterQuantity: tx.afterQuantity !== null && tx.afterQuantity !== undefined ? Number(tx.afterQuantity) : null,
  note: tx.note,
