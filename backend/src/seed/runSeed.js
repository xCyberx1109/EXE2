...
const FEATURE_PERMISSIONS = [
  ...
  // INVENTORY
  { featureCode: 'inventory', permissionCodes: ['INVENTORY_VIEW', 'INVENTORY_CREATE', 'INVENTORY_UPDATE', 'INVENTORY_DELETE', 'INVENTORY_IMPORT', 'INVENTORY_EXPORT', 'INVENTORY_TRANSACTION_VIEW'] },
  // MENU_MANAGEMENT
