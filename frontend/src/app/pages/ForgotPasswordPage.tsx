      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-accent to-muted px-4 py-8">
        <div className="w-full max-w-md bg-card rounded-md shadow-xl overflow-hidden p-4">
          <div className="text-center">
            ...
            <h1 className="text-lg font-bold text-foreground mb-2">Kiểm tra email</h1>
            <p className="text-muted-foreground">
              Nếu email tồn tại trong hệ thống, chúng tôi đã gửi hướng dẫn đặt lại mật khẩu.
            </p>
            <button
              onClick={() => navigate('/login')}
              className="mt-4 inline-flex items-center gap-1.5 text-primary hover:text-primary/80 text-xs"
            >
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-accent to-muted px-4 py-8">
      <div className="w-full max-w-md bg-card rounded-md shadow-xl overflow-hidden p-4">
        <div className="text-center mb-6">
          ...
          <h1 className="text-lg font-bold text-foreground">Quên mật khẩu</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-1.5">
          ...
          >
            {loading ? <><Loader2 className="size-3.5 animate-spin" /> Đang gửi...</> : <>Gửi yêu cầu</>}
          </button>
        </form>
