    ...
    children: [
      {
        ...
        requiredPermission: 'MENU_MANAGEMENT_VIEW',
      },
      {
        name: 'QR gọi món',
        href: '/app/qr-table-print',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: 'Clock',
        requiredPermission: 'ORDER_HISTORY_VIEW',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: '/app/branch',
        icon: 'Building2',
        requiredPermission: 'BRANCH_VIEW',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        href: '/app/billiard',
        icon: 'CircleDot',
        requiredPermission: 'BILLIARD_TABLE_VIEW',
      },
      {
    ...
    children: [
      {
        ...
        href: '/app/order-queue',
        icon: 'ClipboardList',
        requiredPermission: 'POS_ORDER_QUEUE_VIEW',
      },
    ],
  },
];